...
const BaseNavigationContainer = /*#__PURE__*/React.forwardRef(function BaseNavigationContainer({
  ...
  React.useImperativeHandle(ref, () => ({ ...Object.keys(_routers.CommonActions).reduce((acc, name) => {
  ...
  let element = /*#__PURE__*/React.createElement(_useScheduleUpdate.ScheduleUpdateContext.Provider, {
