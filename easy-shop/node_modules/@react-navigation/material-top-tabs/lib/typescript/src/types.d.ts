...
import type { ParamListBase, Descriptor, NavigationHelpers, Route, NavigationProp, TabNavigationState, TabActionHelpers, RouteProp } from '@react-navigation/native';
...
export declare type MaterialTopTabNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, TabNavigationState<ParamList>, MaterialTopTabNavigationOptions, MaterialTopTabNavigationEventMap> & TabActionHelpers<ParamList>;
export declare type MaterialTopTabScreenProps<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = {
...
export declare type MaterialTopTabDescriptor = Descriptor<ParamListBase, string, TabNavigationState<ParamListBase>, MaterialTopTabNavigationOptions>;
